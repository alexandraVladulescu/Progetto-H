 ...
 * per quanto riguarda la comanda selezionata in ComandeListPanel
 * @author Markenos
 */
public class PizzasOrderedPanel extends JPanel {
    ...
    public void update(int selectedComandaIndex){
        ...
        this.updateUI();
        for(Product pizza : pizzeria.getCurrentComandaManager().getComandeManager().getComande().get(selectedComandaIndex).getOrdersList()){
