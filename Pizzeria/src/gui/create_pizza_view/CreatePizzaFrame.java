...
public class CreatePizzaFrame extends JFrame {
    ...
    public CreatePizzaFrame(Pizzeria pizzeria) {
        ...
        this.getContentPane().add(BorderLayout.SOUTH, new CreatePizzaButton("Crea pizza", pizzeria, this, pizzaDetailsPanel, pizzasListPanel));
